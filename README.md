...
| Sept 30 | [ASTRA-sim2.0: Modeling Hierarchical Networks and Disaggregated Systems for Large-model Training at Scale](https://arxiv.org/pdf/2303.14006) (Required)<br>[LLMServingSim: A HW/SW Co-Simulation Infrastructure for LLM Inference Serving at Scale](https://arxiv.org/abs/2408.05499v1) (Required)<br>[Vidur: A Large-Scale Simulation Framework For LLM Inference](https://arxiv.org/abs/2405.05465) | Kaizhuo                    | Akul, Aditi, Shraddhaa                  | Michael, Yikang, Nikhil                   |
